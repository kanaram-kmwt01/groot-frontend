            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 login">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form action="#" method="POST" className="space-y-6">
                        <div>
                            <label htmlFor="Username" className="block text-sm/6 font-medium text-gray-900 lable">
                                Username
                            </label>
                            <div className="mt-2">
                        ...
                        <div>
                            <label htmlFor="email" className="block text-sm/6 font-medium text-gray-900 lable">
                                Email address
                            </label>
                            <div className="mt-2">
                                <input onChange={inputvalue}
